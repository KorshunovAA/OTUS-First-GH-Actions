...
export function pApp(el) {
  ...
  el.innerHTML = `
    ...
    export async function getForecastInMyCity() {
    ...
    export async function getForecast(cityName, myCaller) {

      const weatherInEl = document.querySelector("#weatherIn"); // указатель на поле вывода
      const weatherInfoEl = document.querySelector("#weatherInfo"); // указатель на поле вывода
    ...
    export function createBlocks (obj, tagPointer, catchErr, error) {
